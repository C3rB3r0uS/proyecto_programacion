...
public class Controlador_Log_In implements ActionListener, MouseListener, KeyListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == this.login.jButton_Entrar) {
            ...
            if (dao.ConsultarUserPass(nombreIntroducido, contraseniaIntroducida) == true) {
                ...
                this.jugador = dao.obtenerDatosJugador(nombreIntroducido, contraseniaIntroducida);

                Ventana_Menu vm = new Ventana_Menu();
                vm.jLabel_LogAs.setText("LOG: " + jugador.getNombre_jugador());
